...
export const InstagramFeedSection: React.FC = () => {
  ...
  return (
    <section className="py-20 sm:py-24 bg-gradient-to-b from-[#FFFFFF] via-[#FDFBF7] to-[#FFFFFF] relative z-10 overflow-hidden">
      ...
      {/* Force Instagram embed iframe to take 100% width */}
      <style>{`
        .instagram-media,
          ...
          <div className="w-full bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-1 sm:p-6 md:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border-0 flex justify-center items-center overflow-hidden">
            <div className="w-full flex justify-center">
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/rasmwed/?utm_source=ig_embed&utm_campaign=loading"
              ...
              >
                <div style={{ padding: '16px' }}>
                  <a
                    href="https://www.instagram.com/rasmwed/?utm_source=ig_embed&utm_campaign=loading"
                    style={{
                      background: '#FFFFFF',
                      lineHeight: 0,
                      padding: '0 0',
                    ...
                    <div style={{ display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' }}>
                      <svg width="50px" height="50px" viewBox="0 0 60 60" version="1.1" xmlns="https://www.w3.org/2000/svg">
                        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                          <g transform="translate(-511.000000, -20.000000)" fill="#C5A059">
                            <g>
